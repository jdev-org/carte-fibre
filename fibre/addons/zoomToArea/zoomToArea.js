const zoomToArea = function () {
  ...
  // Get the parent div
  let divParent = document.getElementById("contentMap");

  // Add loader during loading data
  let divLoadingIndicator = document.createElement("div");
  divLoadingIndicator.id = "loadingIndicator-zoomToArea";

  let divLoader = document.createElement("div");
  divLoader.className = "loader";
  divLoader.textContent = "Loading...";

  divLoadingIndicator.appendChild(divLoader);

  divParent.appendChild(divLoadingIndicator);
  ...
  function createSelectorArea(areasData, nameArea, idArea) {
    ...
    if (divParent) {
      // Create the select list
        ...
        select.name = "zoomAreaSelector";
        select.id = "zoomAreaSelector";
    
        let option = document.createElement("option");
        option.value = "";
        option.textContent = options().selectLabel;
